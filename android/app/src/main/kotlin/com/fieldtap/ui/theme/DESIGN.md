...
| `SessionListRow`, `RecordingChip` | A session on one 72 dp rounded card row: neutral status badge, name with its `SignalQualityChip` ("Good -92") or `RecordingChip`, and one line of start, duration and size. |
