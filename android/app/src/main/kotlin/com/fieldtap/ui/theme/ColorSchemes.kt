...
object FieldTapColorSchemes {
    ...
    val Dark: ColorScheme = darkColorScheme(
        ...
        surfaceTint = Color(0xFFAEB6FF),
        inverseSurface = Color(0xFFE8EAF0),
        inverseOnSurface = Color(0xFF2C2F36),
        ...
        scrim = Color(0xFF000000),
        surfaceBright = Color(0xFF2B303B),
        surfaceContainer = Color(0xFF1B1E27),
        surfaceContainerHigh = Color(0xFF1F232D),
